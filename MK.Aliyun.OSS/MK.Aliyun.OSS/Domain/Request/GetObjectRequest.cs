...
namespace Aliyun.OSS
{
    public class GetObjectRequest
    {
        ...
        internal void Populate(IDictionary<string, string> headers)
        {
            ...
            {
                headers.Add(OssHeaders.GetObjectIfModifiedSince, DateUtils.FormatRfc822Date(ModifiedSinceConstraint.Value));
            }

            if (UnmodifiedSinceConstraint != null)
            {
                headers.Add(OssHeaders.GetObjectIfUnmodifiedSince, DateUtils.FormatRfc822Date(UnmodifiedSinceConstraint.Value));
            }
