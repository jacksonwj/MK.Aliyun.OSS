...
namespace Aliyun.OSS.Util
{
    internal static class DateUtils
    {
        ...
        {
            return dtime.ToUniversalTime().ToString(Rfc822DateFormat, CultureInfo.InvariantCulture);
        }
        ...
        {
            return DateTime.SpecifyKind(DateTime.ParseExact(s, Rfc822DateFormat, CultureInfo.InvariantCulture), DateTimeKind.Utc);
        }
        ...
        {
            return dtime.ToUniversalTime().ToString(Iso8601DateFormat, CultureInfo.CurrentCulture);
        }
    }
}
