...
namespace Aliyun.OSS
{
        ...
        public void AddConditionItem(MatchMode matchMode, string name, string value)
        {
            ...
            switch (matchMode)
            {
                ...
                case MatchMode.StartWith:
                    ...
                    break;
                default:
                    //throw new InvalidEnumArgumentException("Unsupported match mode " + matchMode);
                    throw new InvalidEnumArgumentException($"Unsupported match mode {matchMode}");
            }
        }
    ...
    {
        private static IDictionary<string, IList<MatchMode>> _supportedMatchRules = new Dictionary<string, IList<MatchMode>>();
        ...
        public static void Check(MatchMode matchMode, string condName)
        {
            ...
            {
                //throw new ArgumentException(String.Format("Unsupported match mode for condition item {0}", condName));
                throw new ArgumentException($"Unsupported match mode for condition item {condName}");
            }
        }
    }
    ...
    internal class RangeConditionItem : AbstractConditionItem
    {
        ...
        public override string Jsonize()
        {
            ...
            return $"[\"content-length-range\",{Minimum},{Maximum}],";
        }
    }
}
