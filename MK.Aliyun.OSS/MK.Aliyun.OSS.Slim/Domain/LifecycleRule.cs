...
namespace Aliyun.OSS
{
    ...
    public class LifecycleRule : IEquatable<LifecycleRule>
    {
        ...
        public bool Equals(LifecycleRule obj)
        {
            ...
            if (!this.Prefix.Equals(obj.Prefix))
            {
                return false;
            }

            if (this.ExpriationDays != obj.ExpriationDays)
            {
                return false;
            }

            if (this.ExpirationTime != obj.ExpirationTime)
            {
                return false;
            }

            if (this.CreatedBeforeDate != obj.CreatedBeforeDate)
            {
                return false;
            }
            ...
            if (this.AbortMultipartUpload == null && obj.AbortMultipartUpload != null)
            {
                return false;
            }
            ...
            if (this.Transitions == null && obj.Transitions != null || this.Transitions != null && obj.Transitions == null)
            {
                return false;
            }
            ...
            {
                if (this.Transitions.Length != obj.Transitions.Length)
                {
                    return false;
                }
        ...
        public class LifeCycleTransition : IEquatable<LifeCycleTransition>
        {
            ...
            /// </summary>
            /// <value>The life cycle expiration.</value>
            public LifeCycleExpiration LifeCycleExpiration { get; } = new LifeCycleExpiration();
            ...
            public bool Equals(LifeCycleTransition transition)
            {
                ...
                if (this.StorageClass != transition.StorageClass)
                {
                    return false;
                }
