...
namespace Aliyun.OSS
{
    ...
    public class ObjectMetadata
    {
        ...
        /// Gets HTTP standard headers and their values.
        /// </summary>
        public IDictionary<string, object> HttpMetadata { get; } = new Dictionary<string, object>(StringComparer.OrdinalIgnoreCase);
        ...
        public DateTime LastModified
        {
            get
            {
                //return _metadata.ContainsKey(HttpHeaders.LastModified) ? (DateTime)_metadata[HttpHeaders.LastModified] : DateTime.MinValue;
                return HttpMetadata.ContainsKey(HttpHeaders.LastModified) ? (DateTime)HttpMetadata[HttpHeaders.LastModified] : DateTime.MinValue;
            }
            internal set
            {
                //_metadata[HttpHeaders.LastModified] = value;
                HttpMetadata[HttpHeaders.LastModified] = value;
            }
        }
        ...
        public DateTime ExpirationTime
        {
            get
            {
                //return _metadata.ContainsKey(HttpHeaders.Expires) ? DateUtils.ParseRfc822Date((string)_metadata[HttpHeaders.Expires]) : DateTime.MinValue;
                return HttpMetadata.ContainsKey(HttpHeaders.Expires) ? DateUtils.ParseRfc822Date((string)HttpMetadata[HttpHeaders.Expires]) : DateTime.MinValue;
            }
            set
            {
                //_metadata[HttpHeaders.Expires] = DateUtils.FormatRfc822Date(value);
                HttpMetadata[HttpHeaders.Expires] = DateUtils.FormatRfc822Date(value);
            }
        }
        ...
        public long ContentLength
        {
            get
            {
                //return _metadata.ContainsKey(HttpHeaders.ContentLength) ? (long)_metadata[HttpHeaders.ContentLength] : 0;
                return HttpMetadata.ContainsKey(HttpHeaders.ContentLength) ? (long)HttpMetadata[HttpHeaders.ContentLength] : 0;
            }
            set
            {
                //_metadata[HttpHeaders.ContentLength] = value;
                HttpMetadata[HttpHeaders.ContentLength] = value;
            }
        }
        ...
        public string ContentType
        {
            get
            {
                //return _metadata.ContainsKey(HttpHeaders.ContentType) ? _metadata[HttpHeaders.ContentType] as string : null;
                return HttpMetadata.ContainsKey(HttpHeaders.ContentType) ? HttpMetadata[HttpHeaders.ContentType] as string : null;
            }
            set
            {
                if (!string.IsNullOrEmpty(value))
                {
                    ...
                    HttpMetadata[HttpHeaders.ContentType] = value;
                }
            }
        }
        ...
        public string ContentEncoding
        {
            get
            {
                //return _metadata.ContainsKey(HttpHeaders.ContentEncoding) ? _metadata[HttpHeaders.ContentEncoding] as string : null;
                return HttpMetadata.ContainsKey(HttpHeaders.ContentEncoding) ? HttpMetadata[HttpHeaders.ContentEncoding] as string : null;
            }
            set
            {
                if (value != null)
                {
                    ...
                    HttpMetadata[HttpHeaders.ContentEncoding] = value;
                }
            }
        }
        ...
        public string CacheControl
        {
            get
            {
                //return _metadata.ContainsKey(HttpHeaders.CacheControl) ? _metadata[HttpHeaders.CacheControl] as string : null;
                return HttpMetadata.ContainsKey(HttpHeaders.CacheControl) ? HttpMetadata[HttpHeaders.CacheControl] as string : null;
            }
            set
            {
                if (value != null)
                {
                    ...
                    HttpMetadata[HttpHeaders.CacheControl] = value;
                }
            }
        }
        ...
        public string ContentDisposition
        {
            get
            {
                //return _metadata.ContainsKey(HttpHeaders.ContentDisposition) ? _metadata[HttpHeaders.ContentDisposition] as string : null;
                return HttpMetadata.ContainsKey(HttpHeaders.ContentDisposition) ? HttpMetadata[HttpHeaders.ContentDisposition] as string : null;
            }
            set
            {
                if (value != null)
                {
                    ...
                    HttpMetadata[HttpHeaders.ContentDisposition] = value;
                }
            }
        }
        ...
        public string ETag
        {
            get
            {
                //return _metadata.ContainsKey(HttpHeaders.ETag) ? _metadata[HttpHeaders.ETag] as string : null;
                return HttpMetadata.ContainsKey(HttpHeaders.ETag) ? HttpMetadata[HttpHeaders.ETag] as string : null;
            }
            set
            {
                if (value != null)
                {
                    ...
                    HttpMetadata[HttpHeaders.ETag] = value;
                }
            }
        }
        ...
        public string ContentMd5
        {
            get
            {
                //return _metadata.ContainsKey(HttpHeaders.ContentMd5) ? _metadata[HttpHeaders.ContentMd5] as string : null;
                return HttpMetadata.ContainsKey(HttpHeaders.ContentMd5) ? HttpMetadata[HttpHeaders.ContentMd5] as string : null;
            }
            set
            {
                if (value != null)
                {
                    ...
                    HttpMetadata[HttpHeaders.ContentMd5] = value;
                }
            }
        }
        ...
        public string Crc64
        {
            get
            {
                //return _metadata.ContainsKey(HttpHeaders.HashCrc64Ecma) ? _metadata[HttpHeaders.HashCrc64Ecma] as string : null;
                return HttpMetadata.ContainsKey(HttpHeaders.HashCrc64Ecma) ? HttpMetadata[HttpHeaders.HashCrc64Ecma] as string : null;
            }
            set
            {
                if (value != null)
                {
                    ...
                    HttpMetadata[HttpHeaders.HashCrc64Ecma] = value;
                }
            }
        }
        ...
        public string ServerSideEncryption
        {
            get
            {
                //return _metadata.ContainsKey(HttpHeaders.ServerSideEncryption) ? _metadata[HttpHeaders.ServerSideEncryption] as string : null;
                return HttpMetadata.ContainsKey(HttpHeaders.ServerSideEncryption) ? HttpMetadata[HttpHeaders.ServerSideEncryption] as string : null;
            }
            set
            {
                ...
                HttpMetadata[HttpHeaders.ServerSideEncryption] = value;
            }
        }
        ...
        public string ObjectType
        {
            get
            {
                //return _metadata.ContainsKey(HttpHeaders.ObjectType) ? _metadata[HttpHeaders.ObjectType] as string : null;
                return HttpMetadata.ContainsKey(HttpHeaders.ObjectType) ? HttpMetadata[HttpHeaders.ObjectType] as string : null;
            }
        }
        ...
        internal void Populate(IDictionary<string, string> requestHeaders)
        {
            ...
            foreach (var entry in HttpMetadata)
            {
