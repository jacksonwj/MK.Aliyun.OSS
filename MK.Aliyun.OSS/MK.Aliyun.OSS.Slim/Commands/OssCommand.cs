...
namespace Aliyun.OSS.Commands
{
    internal abstract class OssCommand
    {
        ...
        protected bool UseChunkedEncoding { get; private set; }

        protected bool ParametersInUri { get; set; }
    ...
    internal abstract class OssCommand<T> : OssCommand
    {
        ...
        protected OssCommand(IServiceClient client, Uri endpoint, ExecutionContext context, IDeserializer<ServiceResponse, T> deserializer)
            : this(client, endpoint, context, deserializer, false)
        { }

        protected OssCommand(IServiceClient client, Uri endpoint, ExecutionContext context, IDeserializer<ServiceResponse, T> deserializer, bool useChunkedEncoding)
