...
namespace Aliyun.OSS.Common.Communication
{
    internal class ServiceRequest : ServiceMessage, IDisposable
    {
        ...
        public bool ParametersInUri { get; set; }
        ...
        public string BuildRequestUri()
        {
            ...
            if (!uri.EndsWith(delimiter) && (ResourcePath == null || !ResourcePath.StartsWith(delimiter)))
            {
                uri += delimiter;
            }
            ...
            if (IsParameterInUri())
            {
                ...
                var paramString = HttpUtils.ConbineQueryString(Parameters);
